(function () {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/g, 'Julio Sa') );
  ...
  */
  ...
  //*obs console.log(text.replace(/[D-H a-h]/g, 0) );
  // se colocar um espaço entre H e a conforme acima, trocará espaço por 0 também.
  ...
  */
  ...
  //podemos fazer das seguintes formas também:
  //console.log(text.replace(/A|a/g, 4) );
  //console.log(text.replace(/a/gi, 4) ); //i ignore case sensitive g global
  /*
  Substitua a frase "O Centauro de Luvas", deixando-a em caixa alta, usando
  o método `toUpperCase()`. Mostre o resultado no console:
  */
  console.log( '\n"O Centauro de Luvas" em caixa alta:' );
  // *obs para utilizarmos métodos precisamos utilizar via function.
  console.log(text.replace(/O Centauro de Luvas/g, function(phrase) {
    return phrase.toUpperCase();
  }) );
  //*obs sobre capturas. phrase é o primeiro parâmetro da captura
  // que traz a regex inteira, mas se quisessemos caixa alta só no O Centauro
  //alterando de O Centauro de Luvas para O CENTAURO, ficaria assim:
  ...
  */
  ...
  //var regexDate = /(13) de (junho|julho) de (1884)/;
  // trocando para pegar dinamicamente:
