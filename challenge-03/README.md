...
*/
pessoa.nomeCompleto(); // "Olá Meu nome é Julio Sa"
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarPeso(); "Eu peso 89kg"
...
return
'Olá, eu sou ' + sexo + ' ' + pessoa.nomeCompleto +
', tenho ' + pessoa.idade + ' ' + idadeAnos +', '
...
// Agora, apresente-se ;)
pessoa.apresentacao(); // "Olá, eu sou o Julio Sa, tenho 49 anos, 1.77, meu peso é 89 e, só hoje, eu já caminhei 350 metros!"
