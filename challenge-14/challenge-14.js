(function(){
  ...
  */
  ...
  // com base em numberObjects extraindo somente os numeros
  console.log( '\nJust Numbers:' );
  ...
  */
  ...
  // retorno do filter --> [ 2, 3, 4, 6, 8, 9, 10 ]

// fazendo o exe acima com map (não é legal, pois retorna undefined
// para 1, 5 e 7 que não é divisível por 2 e 3 restando zero )
/*
...
console.log(justMod2Or3);
*/
// retorno do map [ undefined, 2, 3, 4, undefined, 6, undefined, 8, 9, 10 ]
  ...
  */
  ...
  }, ''); // se não passar o segundo param '', duplica o P no início PPFer
  console.log(reduceP);
  /*
  ...
  */
  ...
  o que acontece ;)
  */
  // *obs --> explicação aula s15a088 7min
