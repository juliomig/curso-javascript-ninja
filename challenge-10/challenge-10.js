(function () {
  ...
  */
  //var five = '5'; convertendo em número para corrigir
  var five = Number('5');
  console.log( five + ' é número?', typeof five === 'number' );

  // var concat = 10 + 10;
  // convertendo o primeiro 10 em string força a conversão automatica do segundo
  ...
  */
  ...
  /* Uma forma como exemplo, mas não muito funcional
  ...
  // console.log(isOperatorValid('9')); retornará false --> 9 não é um operador
  console.log(isOperatorValid('*')); //retornará true
  */
  //DEFINITIVO
  function isOperatorValid(operator) {
    return !!operation[operator];
    //testando acima o retorno de operation se é um valor
    //truthy (function true) or falsy (undefined false)
  }
  /*
  ...
  */
  function calculator(operator) {
    ...
    return function(x, y) {
      ...
      // é passado desta forma, pois operation é um objeto
      // que recebera um parâmetro string que neste caso não dá para passar obj.propriedade
    };
  }
